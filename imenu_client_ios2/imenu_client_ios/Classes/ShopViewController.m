...
- (void)viewDidLoad
{
    ...
    IMSegmentedControl *seg = [[IMSegmentedControl alloc] initWithFrame:CGRectMake(20, 10, 280, 30)
                                                     withSegmentedItems:@[NSLocalizedString(@"store_sort_title3", nil),
                                                                          NSLocalizedString(@"store_sort_title2", nil),
                                                                          NSLocalizedString(@"store_sort_title1", nil)]
    ...
    switch (navigationItemId)
    {
        ...
        case IM_NAVIGATION_ITEM_MAP:
        {
            ...
            NSDictionary *dic = @{@"category_id":self.categoryId,
                                  ...
                                  @"sort_type":[NSString stringWithFormat:@"%d", 3-self.currentSortIndex],
...
- (void)setCategoryId:(NSString *)categoryId andRegionId:(NSString *)regionId andServiceId:(NSString *)serviceId
{
    if ([categoryId isEqualToString:_categoryId] && [regionId isEqualToString:_regionId] && [serviceId isEqualToString:self.serviceId])
    {
        return;
    }
    ...
    NSLog(@"选择了：【分类】%@，【区域】%@，【服务】%@", categoryId, regionId, serviceId);
    [self loadShopData];
}
