...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        self.orderDate = [[UILabel alloc] initWithFrame:CGRectMake(x, y, 70, 20)];
        self.orderDate.backgroundColor = [UIColor clearColor];
        self.orderDate.text = @"2014/04/04";
        ...
        self.orderState = [[UILabel alloc] initWithFrame:CGRectMake(x, y, 46, 20)];
        self.orderState.backgroundColor = [UIColor clearColor];
        self.orderState.text = @"退款中";
        self.orderState.font = [UIFont systemFontOfSize:SECOND_FONT_SIZE];
        self.orderState.textAlignment = NSTextAlignmentLeft;
        self.orderState.textColor = [UIColor colorWithHtmlColor:@"#008fff"];
