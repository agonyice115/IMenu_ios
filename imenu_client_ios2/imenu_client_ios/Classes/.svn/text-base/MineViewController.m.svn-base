...
#import "OrderListPayedViewController.h"
#import "OrderListShopPayViewController.h"
...
@property (nonatomic, strong) LongBarButton *userOrderNeedPay;
@property (nonatomic, strong) LongBarButton *userOrderPayed;
@property (nonatomic, strong) LongBarButton *userOrderShop;
...
- (void)createHeadView
{
    ...
    self.userScore.frame = CGRectMake(x, height, 80, 30);
    self.userScore.backgroundColor = [UIColor colorWithWhite:0.0f alpha:0.5f];
    self.userScore.layer.masksToBounds = YES;
    self.userScore.layer.cornerRadius = 5.0f;
    self.userScore.titleLabel.font = [UIFont systemFontOfSize:SECOND_FONT_SIZE];
    [self.userScore setTitle:@"5633积分" forState:UIControlStateNormal];
    [self.userScore setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.userScore addTarget:self action:@selector(onClickScore) forControlEvents:UIControlEventTouchUpInside];
    [self.headView addSubview:self.userScore];
    
    self.userMessage = [UIButton buttonWithType:UIButtonTypeCustom];
    self.userMessage.frame = CGRectMake(x+100, height, 40, 30);
    [self.userMessage setImage:[UIImage imageNamed:@"mine_message"] forState:UIControlStateNormal];
    [self.userMessage addTarget:self action:@selector(onClickMessage) forControlEvents:UIControlEventTouchUpInside];
    self.userMessage.contentEdgeInsets = UIEdgeInsetsMake(5, 5, 5, 5);
...
- (void)createScrollView
{
    ...
    height += MIDDLE_BAR_HEIGHT + 10.0f;
    ...
    longBarButton.bgViewType = IMBgViewType_Round;
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 23, 23)];
    ...
    height += MIDDLE_BAR_HEIGHT + 10.0f;
    longBarButton = [[LongBarButton alloc] initWithFrame:CGRectMake(0, height, 320, MIDDLE_BAR_HEIGHT)];
    longBarButton.title.text = @"待付款订单";
    longBarButton.subTitle.text = @"0";
    longBarButton.bgViewType = IMBgViewType_RoundTop;
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 23, 23)];
    ...
    longBarButton.highlightIcon = [UIImage imageNamed:@"order_highlight@2x.png"];
    [tableHeader addSubview:longBarButton];
    [longBarButton setTarget:self action:@selector(onClickOrderNeedPay)];
    self.userOrderNeedPay = longBarButton;
    
    height += MIDDLE_BAR_HEIGHT - 2;
    longBarButton = [[LongBarButton alloc] initWithFrame:CGRectMake(0, height, 320, MIDDLE_BAR_HEIGHT)];
    longBarButton.title.text = @"已付款订单";
    longBarButton.subTitle.text = @"0";
    longBarButton.bgViewType = IMBgViewType_RoundMiddle;
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 23, 23)];
    imageView.image = [UIImage imageNamed:@"order_normal@2x.png"];
    [longBarButton setIconView:imageView];
    longBarButton.normalIcon = imageView.image;
    longBarButton.highlightIcon = [UIImage imageNamed:@"order_highlight@2x.png"];
    [tableHeader addSubview:longBarButton];
    [longBarButton setTarget:self action:@selector(onClickOrderPayed)];
    self.userOrderPayed = longBarButton;
    
    height += MIDDLE_BAR_HEIGHT - 2;
    longBarButton = [[LongBarButton alloc] initWithFrame:CGRectMake(0, height, 320, MIDDLE_BAR_HEIGHT)];
    longBarButton.title.text = @"到店支付订单";
    longBarButton.subTitle.text = @"0";
    longBarButton.bgViewType = IMBgViewType_RoundBottom;
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 23, 23)];
    imageView.image = [UIImage imageNamed:@"order_normal@2x.png"];
    [longBarButton setIconView:imageView];
    longBarButton.normalIcon = imageView.image;
    longBarButton.highlightIcon = [UIImage imageNamed:@"order_highlight@2x.png"];
    [tableHeader addSubview:longBarButton];
    [longBarButton setTarget:self action:@selector(onClickOrderShopPay)];
    self.userOrderShop = longBarButton;
...
//    }
    ...
    if ([cartInfo[@"has_cart"] isEqualToString:@"0"])
    {
        ...
        self.userOrderNeedPay.frame = frame;
        
        frame.origin.y += MIDDLE_BAR_HEIGHT-2;
        self.userOrderPayed.frame = frame;
        
        frame.origin.y += MIDDLE_BAR_HEIGHT-2;
        self.userOrderShop.frame = frame;
        
        frame.origin.y += MIDDLE_BAR_HEIGHT+10;
...
- (void)onClickOrderNeedPay
{
    OrderListNeedPayViewController *vc = [[OrderListNeedPayViewController alloc] initWithNibName:nil bundle:nil];
    [[self getIMNavigationController] pushViewController:vc animated:YES];
}

- (void)onClickOrderPayed
{
    OrderListPayedViewController *vc = [[OrderListPayedViewController alloc] initWithNibName:nil bundle:nil];
    [[self getIMNavigationController] pushViewController:vc animated:YES];
}

- (void)onClickOrderShopPay
{
    OrderListShopPayViewController *vc = [[OrderListShopPayViewController alloc] initWithNibName:nil bundle:nil];
    [[self getIMNavigationController] pushViewController:vc animated:YES];
}
...
- (void)onClickMessage
{
    MessageListViewController *vc = [[MessageListViewController alloc] initWithNibName:nil bundle:nil];
    [[self getIMNavigationController] pushViewController:vc animated:YES];
}
