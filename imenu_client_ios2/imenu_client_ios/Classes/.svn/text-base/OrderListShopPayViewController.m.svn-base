//
//  OrderListShopPayViewController.m
//  imenu_client_ios
//
...
#import "UserData.h"
#import "Networking.h"
#import "OrderShopPayCell.h"

#define TOP_HEADER_VIEW_HEIGHT 50.0f

@interface OrderListShopPayViewController () <UITableViewDataSource, UITableViewDelegate, IMSegmentedControlDelegate>
...
@implementation OrderListShopPayViewController
...
- (void)createSegmentView
{
    ...
    IMSegmentedControl *seg = [[IMSegmentedControl alloc] initWithFrame:CGRectMake(40, 10, width, 30)
...
//    NSDictionary *dic = self.data[startIndex.intValue + indexPath.row];
    ...
    OrderShopPayCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OrderShopPayCell"];
    if (cell == nil)
    {
        cell = [[OrderShopPayCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"OrderShopPayCell"];
    }
