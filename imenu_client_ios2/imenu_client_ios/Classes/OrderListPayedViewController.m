//
//  OrderListPayedViewController.m
//  imenu_client_ios
//
...
#import "UserData.h"
#import "Networking.h"
#import "OrderWaitUseCell.h"
#import "OrderUsedCell.h"
#import "OrderBackCell.h"

#define TOP_HEADER_VIEW_HEIGHT 50.0f

@interface OrderListPayedViewController () <UITableViewDataSource, UITableViewDelegate, IMSegmentedControlDelegate>
...
@implementation OrderListPayedViewController
...
//    NSDictionary *dic = self.data[startIndex.intValue + indexPath.row];
    ...
    {
        OrderWaitUseCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OrderWaitUseCell"];
        if (cell == nil)
        {
            cell = [[OrderWaitUseCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"OrderWaitUseCell"];
        }
    ...
    {
        OrderUsedCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OrderUsedCell"];
        if (cell == nil)
        {
            cell = [[OrderUsedCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"OrderUsedCell"];
        }
    ...
    {
        OrderBackCell *cell = [tableView dequeueReusableCellWithIdentifier:@"OrderBackCell"];
        if (cell == nil)
        {
            cell = [[OrderBackCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"OrderBackCell"];
        }
